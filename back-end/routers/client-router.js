...
router.post('/post',
    ...
    body('data.address_of_the_actual_residence').not().isEmpty().withMessage('Адрес проживания не должен быть пустым').matches(CLIENT_REGEX.text_address).withMessage("Допустимы символы 'ru' алфавита, ' ', '.', ',', цифры"),
    ...
    body('data.address_of_residence').not().isEmpty().withMessage('Адрес прописки не должен быть пустым').matches(CLIENT_REGEX.text_address).withMessage("Допустимы символы 'ru' алфавита, ' ', '.', ',', цифры"),
