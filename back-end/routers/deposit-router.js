...
router.post('/create_deposit_contract',
    body('contract_code').not().isEmpty().withMessage(DEPOSIT_VALIDATION_ERR_MSG.empty).matches(DEPOSIT_REGEX.deposit_line_contract_code),
...
router.post('/cash_in', depositController.cashIn);
router.get('/cash_out', depositController.cashOut);
